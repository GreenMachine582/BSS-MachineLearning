...
setup(
    name='bike-sharing-greenmachine',
    version=version,
    ...
    url='https://github.com/GreenMachine582/Bike-Sharing',
    ...
    keywords='bike-sharing, machine-learning, cross-validation, neural-networks, regression, clustering',
